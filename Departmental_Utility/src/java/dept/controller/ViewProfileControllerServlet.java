 ...
 * @author Shivansh
 */
public class ViewProfileControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String userid=(String) session.getAttribute("userid");
            ...
            try {
                ...
                ProfileDto pd=(ProfileDto) StudentDAO.viewProfile(enroll);
                request.setAttribute("ViewProfile", pd);
